...
#define TIM0_128us()    TCCR0B &= ~((1<<CS02) | (1<<CS01) | (1<<CS00));
#define TIM0_1ms()      TCCR0B &= ~((1<<CS02) | (1<<CS01) | (1<<CS00));
#define TIM0_4ms()      TCCR0B &= ~((1<<CS02) | (1<<CS01) | (1<<CS00));
#define TIM0_16ms()     TCCR0B &= ~((1<<CS02) | (1<<CS01) | (1<<CS00));
